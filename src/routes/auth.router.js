...
router.post("/register", authValidator.registerValidator, validationResultMiddleware, registerController);
router.post("/login", authValidator.loginValidator, validationResultMiddleware, loginController);
